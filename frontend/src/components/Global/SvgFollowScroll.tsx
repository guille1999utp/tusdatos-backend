...
const SvgFollowScroll = () => {
  ...
  return (
    <section
      ref={ref}
      className="mx-auto flex h-[350vh] w-screen flex-col items-center overflow-hidden bg-background px-4 text-primary"
    >
      <div className="mt-42 relative flex w-fit flex-col items-center justify-center gap-5 text-center">
        <h1 className=" relative font-semibold z-10 text-7xl font-medium tracking-[-0.08em] lg:text-9xl">
        ...
        <div className="rounded-4xl font-jakarta-sans w-full translate-y-[200vh] bg-[#1F3A4B] pb-10 text-[#FAFDEE]">
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm">descriocn</p>
