    ...
    <div className=" flex flex-colgap-8">
      <div>
        ...
        <p className="text-muted-foreground text-sm max-w-2xl mt-3">
          ...
          organizador en cada evento: ver inscripciones, asignar o quitar
          personas, cambiar roles (participante, asistente o titular del evento)
          y editar o eliminar cualquier evento.
        </p>
      </div>
      <Separator />
